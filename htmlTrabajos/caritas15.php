...
<html>
  <head>
    <title>Campaña de RP de Cáritas</title>
    <meta name="description" content=" Campaña de Relaciones Públicas de la ONG Cáritas">
    <meta name="keywords" content="donostia, comunicacion, campaña, kapaina, Cáritas, GKE, ONG, HP, RP">
...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
 	...
 	<h2 class= "marra trabajotitulo">CAMPAÑA RP
    <br/>CÁRITAS</h2>
...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
    ...
    <p><span  class="negrita">La ONG Cáritas</span>, confederación oficial de caridad y acción social de la iglésia católica española, fué objeto de nuestro análisis en la universidad. En la <span  class="negrita">campaña de Relaciones Públicas</span> que realizamos para ellos, identificamos sus debilidades y fortalezas para conseguir mayor conciencia social. Para ello, definimos ciertas acciones tanto para dentro de la organización como para fuera de ella.</p>
    
    <p> Ver el trabajo completo <a href="http://openstack.booktype.pro/harreman-publikoetako-kanpaina/_draft/_v/1.0/caritas-harreman-publikoetako-kanpaina/">AQUÍ</a></p>
...
<img src="../img/caritas1.jpg" alt="caritas" class="img-responsive" />

   </div> <!--cierre foto ane 1 del trabajo-->
   
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 paddingfotos">

<img src="../img/caritas2.jpg" alt="caritas" class="img-responsive"/>
